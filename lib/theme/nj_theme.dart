...
class Surface extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        color: color(elevation), child: child, padding: usePadding);
  }
